...
Write-Host "Criando imagem produtos-api:v1 no Docker do Minikube..." -ForegroundColor Green
...
if ($LASTEXITCODE -ne 0) {
    ...
    Write-Host "Erro ao criar a imagem Docker no Minikube." -ForegroundColor Red
...
Write-Host "Imagem criada com sucesso no Minikube: produtos-api:v1" -ForegroundColor Green
